...
Description: This is the main control file for running the modules of
Deianira. It opens the data, creates the cube, merges the orders, applies
barcentric correction, and creates the fits files for iSpec use.
"""
#%%
