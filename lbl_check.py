...
#LIST OF STAR NAMES
stars =['hd_45588','hd_100407','hd_102870','hd_128620','hd_128621','hd_146233','hd_157244','hd_160691','moon','hd_2151','hd_11695','hd_18907','hd_10700','hd_23249','hd_22049','hd_18884','hd_165499','hd_156098']
for star_name in stars:
   # star_name = 'hd_134606'
   abunds = pd.read_csv(abunds_loc + star_name + '/line_by_line_' + element + '.txt', sep=' ')
   ...
   for i, line in abunds.iterrows():
       ...
       synth_spec = glob.glob(synth_spectra_loc + star_name + '/synth_regions_' + element + '/' + 'synth_' + element + '_' + str(round(line['wave_peak'],4))+ '*')[0]
   ...
   plt.savefig(f'{save_loc}lbl_checks/{element}/{star_name}.png', dpi = 300)
plt.show()